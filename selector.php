...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Order of Selection</title>
      ...
      <form id="violeta">
        ...
        <div class="container" id="boxes" data-box="2">
          <?php
                ...
                $examples = ["Claudia Schiffer","Naomi Campbell","Linda Evangelista", "Eva Herzigova","Nadja Auermann","Kate Moss","Almudena Fernandez","Heidi Klum","Gisele Bundchen","Carmen Kass","Helena Christensen","Cindy Crawford","Christy Turlington","Tatjana Patiz","Tyra Banks"];

                $examples = ["Claudia Moro","Lorena Ayala","Veronica Blume","Clara Alonso","Eugenia Silva","Blanca Suarez","Judit Masco","Sonia Ferrer","Belén Fabra","Eva González","Goya Toledo","Rosanna Walls","Eva Sisó","Nati Abascal","Noelia López","Paloma Lago","Natalia Estrada","Almudena Fernández","Carolina Bang","Silvia de Esteban","Ana Milán","Esther Arroyo","Laura Ponte","Inés Sastre","Elisabeth Reyes","Natalia Sánchez","Nuria Bermúdez","Vanessa Lorenzo","Asun Ortega","Berta Collado","Esther Cañadas","Arantxa Santamaria"];
                ...
                $examples = ["Chad","Cuba","Fiji","Iran","Iraq","Laos","Mali","Niue","Oman","Peru","Togo"];

                $format = "\n\t\t\t<span><input id='cb%02d' class='selecta' value='%s' type='checkbox'><label for='cb%02d'>%s</label></span><br>\r";
